...
import { fixedLengthArray, normalizeBassEvents } from "../codec.js";
...
import { parseBassNotes as parseBassNotesFn, sortAndTrimBassEvents } from "../codec.js";
...
export function chordPoolTextState(layerValues, sourceLayerText = null, partCount = 2, formatFn) {
  return Array.from({ length: partCount }, (_, partIndex) => (
    typeof sourceLayerText?.[partIndex] === "string"
      ? sourceLayerText[partIndex]
      : formatFn ? formatFn(layerValues, partIndex) : ""
  ));
}
